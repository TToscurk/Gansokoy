...
const DIR := "res://assets/shrine/"


func _init() -> void:
	for p in ["res://assets/shrine/袖石垣.glb",
			"res://assets/riverbank/塊石疊砌牆一段.glb",
			"res://assets/riverbank/石造堰檻.glb",
			"res://assets/riverbank/收頭件大.glb",
			"res://assets/riverbank/收頭件小.glb"]:
		_one(p)
	quit(0)
