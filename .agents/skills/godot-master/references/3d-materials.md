...
- godot-genre-open-world — Large worlds consume HLOD visibility ranges, dithered distance fade, and shared-material batching patterns from this skill.
...
- godot-adapt-2d-to-3d — Moving flat art into 3D requires PBR map setup, normal import, and transparency mode choices covered here.
