...
- godot-adapt-desktop-to-mobile — Strip SDFGI/heavy shadows and swap to fake bounce GI when targeting Mobile/Compatibility.
...
- godot-monte-carlo-balancer — Simulate visibility/readability under day-night or darkness budgets when lighting changes combat, stealth, or horror difficulty.
- godot-genre-horror — Consumes sparse lights, fog, and ReflectionProbe interiors for tension-first atmospheres.
