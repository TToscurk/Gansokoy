...
**Editor Export UI / template download prose:** use Official Documentation links in Reference — or [export-setup-guide.md](export-builds-export-setup-guide.md) for INI/CLI/platform checklists.
...
- godot-server-architecture — Consumes dedicated-server export presets and headless pipelines for authoritative hosts.
- godot-multiplayer-networking — Client/server binary pairs and feature tags for dedicated vs listen-server packaging.
