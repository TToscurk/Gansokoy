...
| 水邊生物 | 鴨 9・鯉 14・鷺鷥 5 | — |
| 水生植物 | 睡蓮 220・荷 80 | 2 |
| 稗田邸院內植栽 | 生垣 32・紅葉 5・松 2・灌木 12 = 51 株 | 10 |
...
| 稗田邸 | (−78, −164) | 42.4 × 45.6 | 41.5 × 44.7 |
...
13 條路線的 BFS（village 9 / trail 1 / kourindou 2）。`TRIMESH_MIN_SPAN = 15.0`。
**驗不到**：走起來舒不舒服、視線好不好。
...
| 內容 | 築地塀＋藥醫門＋二層入母屋＋長廊／離れ＋石組庭池＋院內植栽 51 株 | 建築＋水池＋枯山水＋飛石＋燈籠＋木戶＋植栽 136 實例 |
...
| 藥醫門兩側各留 1.2m 縫、門高只比牆頂高 0.3m | 牆段 15.2m vs 門屋根 7.2m（缺口 9.6m）；遠看像長凳不像門 |
