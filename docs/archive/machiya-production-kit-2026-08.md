# 町家 Production Kit（已封存 2026-08-26）

> **⚠️ 歷史文件**：170 戶時代的町家生成工具**與町家資產本身**均已於
> 2026-08-25 全數刪除；現行 `village.tscn` 新基線不含任何町屋（使用者
> 2026-08-26 裁定）。本文件僅供日後重建日式建築時參考其幾何／材質語言與
> 變化原則；文中所有工具路徑、命令與資產清單皆已不存在。
