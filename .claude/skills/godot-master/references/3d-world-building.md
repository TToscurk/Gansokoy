...
### [grid_map_logic_manager.gd](../scripts/3d_world_building_grid_map_logic_manager.gd)
Proxy-tile pattern: replace invisible MeshLibrary markers with spawn/trigger scenes at `_ready`, then clear proxy cells.

### [world_streamer.gd](../scripts/3d_world_building_world_streamer.gd)
...
|-------|-------------------|
| GridMap / CSG bake walkthrough | [gridmap-and-csg.md](3d-world-building-gridmap-and-csg.md) |
| Chunk streaming / procgen rooms | [streaming-and-procgen.md](3d-world-building-streaming-and-procgen.md) |
| Proxy spawn tiles | [grid_map_logic_manager.gd](../scripts/3d_world_building_grid_map_logic_manager.gd) |
| Threaded chunk load | [world_streamer.gd](../scripts/3d_world_building_world_streamer.gd) |
## Reference
