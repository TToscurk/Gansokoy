...
| Situation | Choose |
|-----------|--------|
| Gameplay entity behaviors (HP, hitbox, move, interact) | **Composition** — child components + orchestrator ([composition_root_init.gd](../scripts/composition_composition_root_init.gd)) |
...
> Inline Input/Movement/Health recipes removed. **MANDATORY**: start from [composition_root_init.gd](../scripts/composition_composition_root_init.gd), then load the matching script:

- Health / death: [health_component.gd](../scripts/composition_health_component.gd)
- Damage areas: [hit_box_component.gd](../scripts/composition_hit_box_component.gd), [hurt_box_component.gd](../scripts/composition_hurt_box_component.gd)
- Motion: [velocity_component.gd](../scripts/composition_velocity_component.gd)
- Interact / follow / VFX sync: [interaction_component.gd](../scripts/composition_interaction_component.gd), [follower_component.gd](../scripts/composition_follower_component.gd), [visual_sync_component.gd](../scripts/composition_visual_sync_component.gd)
- States / statuses: [state_component_vsm.gd](../scripts/composition_state_component_vsm.gd), [status_effect_component.gd](../scripts/composition_status_effect_component.gd)
...
> **MANDATORY** for Input/Movement/Health orchestrator recipes and registry depth: [orchestrator-recipes.md](composition-orchestrator-recipes.md). **Do NOT Load** when [composition_root_init.gd](../scripts/composition_composition_root_init.gd) + one component script suffice.
