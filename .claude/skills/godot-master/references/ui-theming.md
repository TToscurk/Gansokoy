...
- godot-theme-easter — Seasonal overlays that swap Theme/icon banks on top of this skill.
- godot-composition-apps — App UIs that live or die on Theme consistency.
- godot-genre-visual-novel — Dialogue chrome heavily Theme-driven.
- godot-platform-mobile — Touch-scale and high-contrast theme variants.
