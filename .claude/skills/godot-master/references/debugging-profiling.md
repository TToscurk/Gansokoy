...
|---------|---------------|--------|
| Nodes removed but RAM climbs | `OBJECT_ORPHAN_NODE_COUNT` (debug) | **MANDATORY** [orphan_node_detector.gd](../scripts/debugging_profiling_orphan_node_detector.gd) |
| ObjectDB / instance growth | custom monitors + dump | [memory_usage_threshold_alert.gd](../scripts/debugging_profiling_memory_usage_threshold_alert.gd), [scene_tree_dump.gd](../scripts/debugging_profiling_scene_tree_dump.gd) |
| GPU / overdraw mystery | Visual Profiler (briefly) | Pair with perf skill; use [performance_plotter.gd](../scripts/debugging_profiling_performance_plotter.gd) for trends — do not leave Visual Profiler on |
| Flaky headless / CI exit | exit codes + asserts | **MANDATORY** [automated_qa_suite.gd](../scripts/debugging_profiling_automated_qa_suite.gd), [push_error_safe_exit.gd](../scripts/debugging_profiling_push_error_safe_exit.gd) |
| Microbenchmark lies | `Time.get_ticks_usec` | **MANDATORY** [high_precision_benchmarker.gd](../scripts/debugging_profiling_high_precision_benchmarker.gd) |
| Crash needs locals | backtraces (debug only) | [advanced_backtrace_recorder.gd](../scripts/debugging_profiling_advanced_backtrace_recorder.gd), [stack_trace_logger.gd](../scripts/debugging_profiling_stack_trace_logger.gd) |
| Engine errors to backend | Logger intercept | [engine_error_interceptor.gd](../scripts/debugging_profiling_engine_error_interceptor.gd) — never print inside Logger |
| Custom Debugger metrics | Monitors tab | [custom_editor_monitor.gd](../scripts/debugging_profiling_custom_editor_monitor.gd), [debugger_tab_plugin.gd](../scripts/debugging_profiling_debugger_tab_plugin.gd) |
| Mobile/console no stdout | in-game console | [remote_debug_console.gd](../scripts/debugging_profiling_remote_debug_console.gd), [debug_overlay.gd](../scripts/debugging_profiling_debug_overlay.gd) (debug builds only) |
| Thread races / log corruption | mutex logger / asserts | [thread_safe_logger.gd](../scripts/debugging_profiling_thread_safe_logger.gd), [thread_safety_assert.gd](../scripts/debugging_profiling_thread_safety_assert.gd) |
| Invisible logic (AI/physics) | debug draw / gizmos | [custom_debug_draw.gd](../scripts/debugging_profiling_custom_debug_draw.gd), [property_watcher_gizmo.gd](../scripts/debugging_profiling_property_watcher_gizmo.gd) |
| Conditional halt | hardcoded break | [break_on_condition.gd](../scripts/debugging_profiling_break_on_condition.gd) |
| Editor vs runtime paths | `Engine.is_editor_hint` | [engine_editor_hint_logic.gd](../scripts/debugging_profiling_engine_editor_hint_logic.gd) |

## Available Scripts (full catalog)

### Leaks & memory
- [orphan_node_detector.gd](../scripts/debugging_profiling_orphan_node_detector.gd)
- [memory_usage_threshold_alert.gd](../scripts/debugging_profiling_memory_usage_threshold_alert.gd)
- [scene_tree_dump.gd](../scripts/debugging_profiling_scene_tree_dump.gd)

### Timing & QA
- [high_precision_benchmarker.gd](../scripts/debugging_profiling_high_precision_benchmarker.gd)
- [automated_qa_suite.gd](../scripts/debugging_profiling_automated_qa_suite.gd)
- [push_error_safe_exit.gd](../scripts/debugging_profiling_push_error_safe_exit.gd)
...
- [stack_trace_logger.gd](../scripts/debugging_profiling_stack_trace_logger.gd)
...
- [thread_safety_assert.gd](../scripts/debugging_profiling_thread_safety_assert.gd)

### Editor / remote / viz
- [custom_editor_monitor.gd](../scripts/debugging_profiling_custom_editor_monitor.gd)
- [debugger_tab_plugin.gd](../scripts/debugging_profiling_debugger_tab_plugin.gd) — unregister in `_exit_tree()`
- [remote_debug_console.gd](../scripts/debugging_profiling_remote_debug_console.gd)
- [debug_overlay.gd](../scripts/debugging_profiling_debug_overlay.gd) — debug builds only
- [custom_debug_draw.gd](../scripts/debugging_profiling_custom_debug_draw.gd)
- [property_watcher_gizmo.gd](../scripts/debugging_profiling_property_watcher_gizmo.gd)
- [break_on_condition.gd](../scripts/debugging_profiling_break_on_condition.gd)
- [engine_editor_hint_logic.gd](../scripts/debugging_profiling_engine_editor_hint_logic.gd)
...
> **MANDATORY** for print/breakpoint workflow depth, profiler interpretation, and expert CI/GPU/thread patterns: [debug-workflows.md](debugging-profiling-debug-workflows.md). **Do NOT Load** when the symptom → script table above already routes you.
